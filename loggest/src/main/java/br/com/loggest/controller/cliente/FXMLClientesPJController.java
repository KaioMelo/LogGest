...
public class FXMLClientesPJController implements Initializable {
    @Override
    ...
    @FXML
    public void handleCadastrarClientes(ActionEvent event) throws IOException {
        loadScene("/view/cliente/FXMLCadastrarClientesPJ.fxml", event);
    }
}
