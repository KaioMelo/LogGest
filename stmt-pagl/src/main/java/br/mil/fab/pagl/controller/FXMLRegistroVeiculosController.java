...
public class FXMLRegistroVeiculosController implements Initializable {
    @Override
    ...
    @FXML
    public void handleCadastrarVeiculo(Event event) throws IOException{
        loadScene("/view/FXMLCadastrarVeiculos.fxml", event);
    }
}
